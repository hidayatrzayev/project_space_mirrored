...
public class SessionSystem {
    ...
    public void saveProgress(){
        try {
            FileWriter myWriter = new FileWriter("progress.json");
    ...
    public void loadProgress(){
        try {
            ...
            JSONObject sessionSystem = (JSONObject)parser.parse(new FileReader("progress.json"));
    ...
    public void startNewGame(){
        JSONParser parser = new JSONParser();
        try {
            JSONArray levels = (JSONArray)parser.parse(new FileReader("universe.json"));
